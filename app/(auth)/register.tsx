...
import { Dimensions, Image, KeyboardAvoidingView, Platform, ScrollView, Text, TouchableOpacity, useColorScheme, View } from 'react-native';
          ...
          >
            <View style={{flex:1,alignItems:'center',justifyContent:'center',gap:10}}>
              <Image
                ...
                resizeMode="contain"
              />
              <Text style={{fontFamily:'fontBold',color:colors.white}}>Your ultimate music experience</Text>
            </View>
          </LinearGradient>
        }
      ...
      >
        <View style={{flex:1, paddingBottom: 50}}>
          ...
          <View>
            <CustomSwitch
              attr={{
                title: "I accept https://playmyjam.empiredigitals.org/terms",
